#Citation Source - @MedViT - Manzari, O. N., Ahmadabadi, H., Kashiani, H., Shokouhi, S. B., & Ayatollahi, A. (2023). MedViT: a robust vision transformer for generalized medical image classification. Computers in biology and medicine, 157, 106791.
...
def merge_pre_bn(module, pre_bn_1, pre_bn_2=None):
    ...
    if pre_bn_2 is None:
        ...
        assert pre_bn_1.affine is True
        ...
        assert pre_bn_2.affine is True
